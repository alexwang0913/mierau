                                        ...
                                        <div class="col-12">
                                            <div class="chart-container">
                                              ...
                                              <div className="chart-area">
                                                  <Doughnut height={180} data={data1} options={options1} />
                                              </div>
                                ...
                                <div class="content-body">        <div class="row">
                                        <div class="col-12">
                                            <div class="chart-container">
                                                ...
                                                <div className="chart-area">
                                                  <Line data={data3} options={options3} height={200} />
                                                </div>
                        ...
                        <div class="col-12 col-lg-6 col-xl-4">
                            <section class="box ">
                                ...
                                <div class="content-body">        <div class="row">
                                        <div class="col-12">
                                            <div class="chart-container">
                                              <Scatter data={data4} options={options4} height={200} />
                                            </div>
                                        </div>      
                                    </div> 
                                </div>
                        ...
                        <div class="col-12 col-lg-6 col-xl-4">
                            <section class="box ">
                                ...
                                <div class="content-body">        <div class="row">
                                        <div class="col-12">
                                            <div class="chart-container">
                                                <Radar data={data6}  options={options6} height={200}/>
                                            </div>
                                        </div>      
                                    </div> 
                                </div>
