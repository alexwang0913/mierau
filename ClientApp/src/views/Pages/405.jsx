...
class Page405 extends React.Component{
                    ...
                    <section class="box nobox ">
                        <div class="content-body">    <div class="row">
                                <div class="col-12">
                                    ...
                                    <h1 class="page_error_code text-primary">405</h1>
                                    <h1 class="page_error_info">Oops! Not Allowed</h1>
                                    <div class="row">
                                        <div class="offset-lg-3 offset-md-3 offset-2 col-8 col-md-6">
