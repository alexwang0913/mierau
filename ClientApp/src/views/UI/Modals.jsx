...
<div>
        <Form inline onSubmit={(e) => e.preventDefault()}>
          <FormGroup>
            <Label for="backdrop1">Backdrop value</Label>{' '}
            <Input type="select" name="backdrop1" id="backdrop1" onChange={this.changeBackdrop}>
          ...
          {' '}
          <Button color="primary" onClick={this.toggle1}>Control Backdrop Modal</Button>
        </Form>
