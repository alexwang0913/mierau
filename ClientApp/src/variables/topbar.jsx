...
const messages = [
    {avatar: "images/profile/avatar-1.png", name: "Clarrie Vasar", time: "15 mins ago", status: "available", type: "read", msg: 'Sometimes it takes a lifetime to win a battle!'},
    {avatar: "images/profile/avatar-2.png", name: "Brooks Shaw", time: "35 mins ago", status: "busy", type: "read", msg: 'Sometimes it takes a lifetime to win a battle!'},
    {avatar: "images/profile/avatar-3.png", name: "Carrie Busey", time: "45 mins ago", status: "away", type: "unread", msg: 'Sometimes it takes a lifetime to win a battle!'},
    {avatar: "images/profile/avatar-4.png", name: "Kate Denwer", time: "50 mins ago", status: "offline", type: "read", msg: 'Sometimes it takes a lifetime to win a battle!'},
];
